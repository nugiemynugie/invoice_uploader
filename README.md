...
- Saat simpan memory, dropdown `source_variable` menampilkan **semua variable hasil scan** beserta contoh valuenya (mis. `analysis.vendor => PT ABC`, `analysis.invoice_number => INV-001`).
